    ...
    <>
      ...
      <div className="sign-up-form">
        <div className='form-fields-1'>
          <input className="form-input" type="text" name="businessLocation" value={formData.businessLocation} onChange={handleChange} />
          <label className='form-lable-1'> Business Location</label>
        </div>
        <div className="sign-up-form">
